          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="txtnombre" placeholder="Nombre completo" readonly="true" required="required" style="width: 80%;">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="txtcorreoE" placeholder="Correo electrónico" readonly="true" required="required" style="width: 79%;">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="password" class="form-control" name="txtcontrasena" placeholder="Contraseña" readonly="true" required="required" style="width: 79%;">
